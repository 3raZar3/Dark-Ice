...
{
{"Are you ready for the test Crusader?",GOSSIP_ACTION_INFO_DEF+1,false,TYPE_BEASTS}, //
...
{"Are you ready for the next stage?",GOSSIP_ACTION_INFO_DEF+5,false,TYPE_VALKIRIES}, //
{"Are you ready to continue to the battle with Anub-Araki?",GOSSIP_ACTION_INFO_DEF+6,true,TYPE_LICH_KING}, //
{"Do not poke around here. The arena is closed today.",GOSSIP_ACTION_INFO_DEF+7,true,TYPE_ANUBARAK}, //
};
enum
{
         NUM_MESSAGES = 7,
